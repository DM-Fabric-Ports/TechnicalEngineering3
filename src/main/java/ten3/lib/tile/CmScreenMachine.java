...
public class CmScreenMachine extends CmScreen<CmContainerMachine> {
	...
	public CmScreenMachine(CmContainerMachine container, Inventory inv, Component titleIn,
			String path, int textureW, int textureH) {
	...
	public void containerTick() {
		...
		bar_energy.update(container.data.get(EFF_AUC), container.data.get(EFF),
				container.data.get(E_REC), container.data.get(E_EXT), container.data.get(I_REC),
